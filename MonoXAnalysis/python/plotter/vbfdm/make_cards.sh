...
EVVARFRIEND_DIR="friends_SR"
if [[ "$1" == "all" || "$1" == "SR" ]] ; then
    OPTIONS_SR="${OPTIONS} -P \"$TREEMET\" -F mjvars/t \"$TREEMET/${EVVARFRIEND_DIR}/evVarFriend_{cname}.root\" --FMC sf/t \"$TREEMET/friends/sfFriend_{cname}.root\" -W 'puw*SF_trigmetnomu*SF_BTag*SF_NLO_QCD*SF_NLO_EWK' "
...
EVVARFRIEND_DIR="friends_VM"
if [[ "$1" == "all" || "$1" == "ZM" ]] ; then
    OPTIONS_ZM="${OPTIONS} -P \"$TREEMET\" -F mjvars/t \"$TREEMET/${EVVARFRIEND_DIR}/evVarFriend_{cname}.root\" --FMC sf/t \"$TREEMET/friends/sfFriend_{cname}.root\" -W 'puw*SF_trigmetnomu*SF_LepTightLoose*SF_BTag*SF_NLO_QCD*SF_NLO_EWK' "
...
EVVARFRIEND_DIR="friends_VE"
if [[ "$1" == "all" || "$1" == "ZE" ]] ; then
    OPTIONS_ZE="${OPTIONS} -P \"$TREELEP\" -F mjvars/t \"$TREELEP/${EVVARFRIEND_DIR}/evVarFriend_{cname}.root\" --FMC sf/t \"$TREELEP/friends/sfFriend_{cname}.root\" -W 'puw*SF_LepTightLoose*SF_BTag*SF_NLO_QCD*SF_NLO_EWK' "
...
EVVARFRIEND_DIR="friends_VM"
if [[ "$1" == "all" || "$1" == "WM" ]] ; then
    OPTIONS_WM="${OPTIONS} -P \"$TREEMET\" -F mjvars/t \"$TREEMET/${EVVARFRIEND_DIR}/evVarFriend_{cname}.root\" --FMC sf/t \"$TREEMET/friends/sfFriend_{cname}.root\" -W 'puw*SF_trigmetnomu*SF_LepTight*SF_BTag*SF_NLO_QCD*SF_NLO_EWK' "
...
EVVARFRIEND_DIR="friends_VE"
if [[ "$1" == "all" || "$1" == "WE" ]] ; then
    OPTIONS_WE="${OPTIONS} -P \"$TREELEP\" -F mjvars/t \"$TREELEP/${EVVARFRIEND_DIR}/evVarFriend_{cname}.root\" --FMC sf/t \"$TREELEP/friends/sfFriend_{cname}.root\" -W 'puw*SF_LepTight*SF_BTag*SF_NLO_QCD*SF_NLO_EWK' "
